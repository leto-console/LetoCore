...
private:
	...
	static IDataCell<int32_t>* smooth_calib_pulses;
...
public:
	 ...
	 * Init cells
	 */
	static void InitCells(IDataCell<DateTimeStruct>* _last_exact_datetime, IDataCell<int32_t>* _smooth_calib_pulses);
